...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/RajCreation_Officiial")]]),
        parse_mode="html",
...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ CHANNEL ⭕️", url="https://t.me/RajCreation_Officiial")], [InlineKeyboardButton(text="😇 SUPPORT", url="https://t.me/RajCreation_Officiial"),
